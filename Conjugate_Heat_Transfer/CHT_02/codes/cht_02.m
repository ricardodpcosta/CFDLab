...
function res = nAB(x, y)
    ...
    theta = atan2(y, x);
    res = zeros(2,1);
    res(1) = betaAB_1.*betaAB_2.*rAB.*sin(theta).*sin(betaAB_2.*theta)./sqrt(betaAB_1.^2.*betaAB_2.^2. ...
        *rAB.^2.*sin(betaAB_2.*theta).^2 + rAB.^2.*(betaAB_1.*cos(betaAB_2.*theta) + 1).^2) - rAB. ...
        *(betaAB_1.*cos(betaAB_2.*theta) + 1).*cos(theta)./sqrt(betaAB_1.^2.*betaAB_2.^2.*rAB.^2. ...
        *sin(betaAB_2.*theta).^2 + rAB.^2.*(betaAB_1.*cos(betaAB_2.*theta) + 1).^2);
    res(2) = -betaAB_1.*betaAB_2.*rAB.*sin(betaAB_2.*theta).*cos(theta)./sqrt(betaAB_1.^2.*betaAB_2.^2. ...
        *rAB.^2.*sin(betaAB_2.*theta).^2 + rAB.^2.*(betaAB_1.*cos(betaAB_2.*theta) + 1).^2) - rAB. ...
        *(betaAB_1.*cos(betaAB_2.*theta) + 1).*sin(theta)./sqrt(betaAB_1.^2.*betaAB_2.^2.*rAB.^2. ...
        *sin(betaAB_2.*theta).^2 + rAB.^2.*(betaAB_1.*cos(betaAB_2.*theta) + 1).^2);
end
