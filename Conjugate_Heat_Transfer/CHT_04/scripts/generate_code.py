...
print("")
print("")
sympy.pprint(gradphiA_r_rAB)

print("")
print("")
print("")
sympy.pprint(gradphiA_theta_rAB)
...
H = alphaA*(gradphiA_r_rAB*nAB_r + gradphiA_theta_rAB*nAB_theta)/(h*phi_jump_rAB)
