...
This benchmark represents a **stationary two-dimensional isothermal incompressible fluid flow** problem with vorticies confined between two circular boundaries. It is particularly suitable for solvers of the **stationary Navier-Stokes equations** with solenoidal velocity fields. The case is based on a **manufactured analytical solution** in polar coordinates, enabling:
